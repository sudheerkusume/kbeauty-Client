        ...
        <section className="contact-page py-5">
            <div className="container py-lg-5">
                <div className="text-center mb-5" data-aos="fade-up">
                    ...
                    <h1 className="contact-title display-3">Let's Start Your <br /><span>Glow Journey</span></h1>
                ...
                <div className="row g-5 align-items-stretch">
                    ...
                    <div className="col-lg-5" data-aos="fade-right">
                        <div className="contact-card h-100">
                            <div className="contact-image-wrapper">
                                <img src={contactBg} alt="K-Beauty Aesthetic" />
                            </div>
                            ...
                            <div className="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="mb-0 text-muted">+91 __________</p>
                                </div>
                            </div>
                            ...
                            <div className="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="mb-0 text-muted">__________@kbeautymart.com</p>
                                </div>
                            </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p className="mb-0 text-muted">Kakinada, Andhra Pradesh, India</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-7" data-aos="fade-left">
                        <div className="contact-card">
                            ...
                            <p className="text-muted mb-5">Drop us a line and we'll get back to you within 24 hours.</p>

                            <form onSubmit={submitHandler}>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="mb-4">
                                            <label className="form-label small fw-bold text-uppercase ms-2 text-coral">Full Name</label>
                                            <input
                                                name='name'
                                                value={name}
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-4">
                                            <label className="form-label small fw-bold text-uppercase ms-2 text-coral">Mobile Number</label>
                                            <input
                                                name='mobile'
                                                value={mobile}
                                ...
                                <div className="mb-4">
                                    <label className="form-label small fw-bold text-uppercase ms-2 text-coral">Email Address</label>
                                    <input
                                        name='email'
                                        type='email'
                                        value={email}
                                ...
                                <div className="mb-4">
                                    <label className="form-label small fw-bold text-uppercase ms-2 text-coral">Your Message</label>
                                    <textarea
                                        name='message'
                                        value={message}
